...
const RAW_MEMBERS: Array<Omit<CnsoMember, "clubId">> = [
  {
    ...
    activity_en: "First Team · Backstroke",
    activity_sr: "Prvi tim · Leđno",
    level: "Élite",
    status: "active",
    joinedAt: "2017-09-01",
    goal: "Bajar de 2:15 en 200 espalda largo.",
    goal_en: "Break 2:15 in long-course 200 backstroke.",
    goal_sr: "Ispod 2:15 na 200 leđno u dugom bazenu.",
    notes: "Mejora notable en arranques tras bloque de seco.",
    notes_en: "Noticeable improvement in starts after the dryland block.",
    notes_sr: "Primetno poboljšanje startova nakon bloka na suvom.",
    bestTimes: [
  ...
  },
  {
    ...
    activity_en: "Development · Butterfly",
    activity_sr: "Razvojni program · Delfin",
    level: "Competición",
    status: "active",
    joinedAt: "2019-09-15",
    goal: "Consolidar técnica de mariposa y bajar 1:05 en 100 m.",
    goal_en: "Lock in butterfly technique and break 1:05 in the 100 m.",
    goal_sr: "Učvrstiti tehniku delfina i spustiti se ispod 1:05 na 100 m.",
    notes: "Foco en respiración asimétrica y patada ondulatoria.",
    notes_en: "Focus on asymmetric breathing and undulating kick.",
    notes_sr: "Fokus na asimetrično disanje i talasast udarac nogama.",
    bestTimes: [
  ...
  },
  {
    ...
    goal_en: "Complete the 5 km San Lorenzo Beach swim.",
    goal_sr: "Završiti plivanje od 5 km na plaži San Lorenzo.",
    notes: "Plan combinado piscina + aguas abiertas en primavera.",
    notes_en: "Combined pool + open-water plan in spring.",
    notes_sr: "Kombinovani plan bazen + otvorene vode na proleće.",
  ...
  },
  {
    ...
    activity: "Triatlón",
    activity_en: "Triathlon",
    activity_sr: "Triatlon",
    level: "Competición",
    status: "active",
    joinedAt: "2020-06-12",
    goal: "Preparar Triatlón Villa de Gijón Sprint.",
    goal_en: "Prepare for the Villa de Gijón Sprint Triathlon.",
    goal_sr: "Priprema za sprint triatlon Vilja de Hihon.",
    notes: "Buen umbral aeróbico, mejorar transiciones.",
    notes_en: "Solid aerobic threshold; improve transitions.",
    notes_sr: "Dobar aerobni prag; poboljšati tranzicije.",
    bestTimes: [
  ...
  },
  {
    ...
    activity_en: "School · Alevín",
    activity_sr: "Škola · mlađi kadeti",
    level: "Perfeccionamiento",
    status: "active",
    joinedAt: "2021-09-01",
    goal: "Mejorar viraje de espalda y participar en Trofeo Villa.",
    goal_en: "Improve backstroke turn and race the Villa Trophy.",
    goal_sr: "Poboljšati okret na leđno i takmičiti se na Vilja trofeju.",
    notes: "Excelente actitud, motivación alta.",
    notes_en: "Excellent attitude, highly motivated.",
    notes_sr: "Odličan stav, visoka motivacija.",
  ...
  },
  {
    ...
    coachName: "Hugo Vega",
    activity: "Waterpolo",
    activity_en: "Water polo",
    activity_sr: "Vaterpolo",
    level: "Competición",
    status: "active",
    joinedAt: "2018-09-10",
    goal: "Consolidar puesto de boya en categoría sub-18.",
    goal_en: "Lock in the hole-set spot in U-18.",
    goal_sr: "Učvrstiti poziciju centra u U-18 kategoriji.",
    notes: "Trabajo específico de potencia de remate.",
    notes_en: "Specific work on shooting power.",
    notes_sr: "Specifičan rad na snazi šuta.",
    bestTimes: [],
  },
  {
    id: "n-7",
    ...
    activity_en: "Artistic Swimming",
    activity_sr: "Umetničko plivanje",
    level: "Competición",
    status: "active",
    joinedAt: "2019-09-12",
    goal: "Rutina equipo libre infantil para Cto. Asturias.",
    goal_en: "Youth free team routine for the Asturias Championship.",
    goal_sr: "Slobodna ekipna rutina za omladince na prvenstvu Asturije.",
    notes: "Flexibilidad excelente, mejorar apnea.",
    notes_en: "Excellent flexibility; improve breath-hold.",
    notes_sr: "Odlična fleksibilnost; poboljšati zadržavanje daha.",
    bestTimes: [],
  },
  {
    id: "n-8",
    ...
    activity_en: "School · Youth · Medley",
    activity_sr: "Škola · kadeti · Mešovito",
    level: "Perfeccionamiento",
    status: "active",
    joinedAt: "2018-09-10",
    goal: "Pasar a Tecnificación la próxima temporada.",
    goal_en: "Move up to the Development group next season.",
    goal_sr: "Preći u razvojnu grupu naredne sezone.",
    notes: "Marca propia en 200 estilos esta semana.",
    notes_en: "Personal best in the 200 medley this week.",
    notes_sr: "Lični rekord na 200 mešovito ove nedelje.",
  ...
  },
  {
    ...
    activity_en: "First Team · Freestyle",
    activity_sr: "Prvi tim · Kraul",
    level: "Élite",
    status: "active",
    joinedAt: "2014-09-01",
    goal: "Mínima nacional 100 crol absoluta.",
    goal_en: "Senior national qualifying time in the 100 freestyle.",
    goal_sr: "Nacionalna norma u seniorskoj kategoriji na 100 kraul.",
    notes: "Volumen alto, monitorizar carga acumulada.",
    notes_en: "High volume; monitor accumulated load.",
    notes_sr: "Visok obim; pratiti akumulirano opterećenje.",
    bestTimes: [
  ...
  },
  {
    ...
    activity_en: "School · Benjamin",
    activity_sr: "Škola · početnici",
    level: "Iniciación",
    status: "active",
    joinedAt: "2022-09-12",
    goal: "Aprender salida desde poyete.",
    goal_en: "Learn the block start.",
    goal_sr: "Naučiti start sa startnog bloka.",
    notes: "Primer año en competiciones internas.",
    notes_en: "First year in internal competitions.",
    notes_sr: "Prva godina na internim takmičenjima.",
    bestTimes: [],
  },
];
