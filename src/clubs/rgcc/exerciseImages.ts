...
export const RGCC_EXERCISE_IMAGES: Record<string, string> = {
  "ex-1": ex1, "ex-2": ex2, "ex-3": ex3, "ex-4": ex4, "ex-5": ex5,
  "ex-6": ex6, "ex-7": ex7, "ex-8": ex8, "ex-9": ex9, "ex-10": ex10,
  "ex-11": ex11, "ex-12": ex12, "ex-13": ex13, "ex-14": ex14,
  "ex-15": ex15, "ex-16": ex16,
