...
export const RGCC_SESSIONS: RgccSession[] = [
  {
    ...
    roomLabel: "GRUPOFIT",
    venueId: "s-grupo",
    roomId: "sala-grupofit",
    primaryCoach: "Sheila",
    capacity: 30,
    bookings: ["RGCC-04212", "RGCC-05122", "RGCC-04999"],
    waitlist: [],
    status: "confirmed",
  },
  {
  ...
  },
  {
    ...
    venueId: "s-grupo",
    roomId: "sala-trx",
    primaryCoach: "Maria A C",
    capacity: 14,
    bookings: ["RGCC-05011", "RGCC-04555"],
    waitlist: [],
    status: "confirmed",
  },
  {
    ...
    time: "18:30",
    durationMin: 55,
    activity: "CICLO INDOOR",
    roomLabel: "CICLO INDOOR",
    venueId: "s-grupo",
    roomId: "sala-ciclo",
    primaryCoach: "Jano",
    capacity: 22,
  ...
  },
  {
    ...
    durationMin: 55,
    activity: "GAP",
    roomLabel: "POLIVALENTE BEGOÑA",
    venueId: "s-begona",
    roomId: "sala-bego-poli",
    primaryCoach: "Sheila",
    capacity: 24,
    bookings: ["RGCC-04212"],
    waitlist: [],
  ...
  },
  {
    ...
    time: "10:30",
    durationMin: 55,
    activity: "FUNCIONAL PLAYA",
    roomLabel: "GIMNASIO PLAYA",
    venueId: "s-grupin",
    roomId: "sala-grupin-gim",
    primaryCoach: "Sheila",
    capacity: 35,
    bookings: ["RGCC-05011"],
    waitlist: [],
  ...
  },
  {
    ...
    time: "18:00",
    durationMin: 60,
    activity: "PÁDEL DIRIGIDO",
    roomLabel: "PISTA EXTERIOR MAREO",
    venueId: "s-mareo",
    roomId: "sala-mareo-ext",
    primaryCoach: "Juan",
    capacity: 12,
    bookings: ["RGCC-03988", "RGCC-04777"],
    waitlist: [],
    status: "scheduled",
  },
  {
...
export const RGCC_ABSENCES: RgccAbsence[] = [
  {
    ...
    to: today(),
    reason: "Enfermedad",
    detail: "Lumbalgia, parte médico enviado.",
    status: "requested",
