        ...
        <div className="mx-auto grid max-w-5xl gap-10 px-4 sm:px-6 lg:grid-cols-[1.3fr_1fr] lg:px-8">
          ...
          >
            {sent ? (
              <div className="flex flex-col items-center gap-3 py-10 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  {t(
                    ...
                    "We'll contact you within 24 working hours.",
                  )}
                </p>
              </div>
            ) : (
              <div className="space-y-5">
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input
                      id="role"
                      required
                      placeholder={t("Presidente, gerente…", "President, manager…")}
                    />
                  </div>
                </div>
                <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="msg">
                    {t("Cuéntanos sobre tu club", "Tell us about your club")}
                  </Label>
                  <Textarea
                    id="msg"
                    rows={4}
                    placeholder={t(
                      "Herramientas actuales, prioridades, plazos…",
                      "Current tools, priorities, timeline…",
                    )}
                  />
                </div>
          ...
          <aside className="space-y-4">
            <div className="rounded-2xl border border-border bg-card p-6">
              ...
              <p className="text-xs text-muted-foreground">
                {t("Respondemos en 24h laborables.", "We reply within 24 working hours.")}
              </p>
            </div>
            <div className="rounded-2xl border border-border bg-card p-6">
              ...
              <p className="text-xs text-muted-foreground">
                {t("Lun-Vie · 9:00 – 18:00", "Mon-Fri · 9:00 – 18:00")}
              </p>
            </div>
            <div className="rounded-2xl border border-border bg-card p-6">
              <Building2 className="size-5 text-primary" />
              <p className="mt-3 text-sm font-semibold">
                {t("Para clubes y federaciones", "For clubs and federations")}
              </p>
              <p className="text-xs text-muted-foreground">
                {t(
                  "Onboarding asistido y migración incluida.",
                  "Assisted onboarding and migration included.",
                )}
              </p>
            </div>
          </aside>
