    ...
    <section className="py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title={t(locale, { es: "Una IA con permisos, límites y supervisión", en: "AI with permissions, limits and oversight" })}
        />
            ...
            return (
              <div key={title} className="flex gap-4 rounded-2xl border border-border bg-card p-6 shadow-sm">
                ...
                <div>
                  ...
                  <p className="mt-1.5 text-sm leading-relaxed text-muted-foreground">{t(locale, p.desc)}</p>
                </div>
              </div>
            );
          })}
