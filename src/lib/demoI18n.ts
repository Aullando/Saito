...
const MAP: Record<string, Tri> = {
  ...
  Movilidad: { en: "Mobility", sr: "Pokretljivost" },
  Prevención: { en: "Prevention", sr: "Prevencija" },
  Reeducación: { en: "Rehab", sr: "Reedukacija" },
  "Técnica deportiva": { en: "Sport technique", sr: "Sportska tehnika" },
  Core: { en: "Core", sr: "Core" },
  Inicial: { en: "Beginner", sr: "Početni" },
  Intermedio: { en: "Intermediate", sr: "Srednji" },
  Avanzado: { en: "Advanced", sr: "Napredni" },
  ...
  "Sección histórica con torneos y formación.": { en: "Historic section with tournaments and training.", sr: "Istorijska sekcija sa turnirima i obukom." },
  "Pruebas de pista, ruta y campo a través.": { en: "Track, road and cross-country events.", sr: "Trkačka, drumska i kros takmičenja." },
  "Equipos en categorías de base y senior.": { en: "Youth and senior category teams.", sr: "Ekipe u mlađim i seniorskim kategorijama." },
  "Competición autonómica y nacional.": { en: "Regional and national competition.", sr: "Regionalno i nacionalno takmičenje." },
  "Salas y modalidades libre y carambola.": { en: "Rooms and free and carom modes.", sr: "Sale, slobodni i karambol modaliteti." },
  "Bolo asturiano, tradición viva.": { en: "Asturian bowls, living tradition.", sr: "Asturijski kuglanje, živa tradicija." },
  "Iniciación, técnica y competición amateur.": { en: "Beginner, technique and amateur competition.", sr: "Početno, tehnika i amaterska takmičenja." },
  "Folclore asturiano y representación.": { en: "Asturian folklore and performance.", sr: "Asturijski folklor i nastupi." },
  "Programas inclusivos multidisciplinares.": { en: "Multidisciplinary inclusive programmes.", sr: "Multidisciplinarni inkluzivni programi." },
  "Salidas a Pajares y competición FIS.": { en: "Pajares outings and FIS competition.", sr: "Izleti u Pajares i FIS takmičenja." },
  "Gimnasia Artística Femenina.": { en: "Women's Artistic Gymnastics.", sr: "Ženska sportska gimnastika." },
  "Gimnasia Artística Masculina.": { en: "Men's Artistic Gymnastics.", sr: "Muška sportska gimnastika." },
  "Levantamientos olímpicos.": { en: "Olympic lifting.", sr: "Olimpijsko dizanje tegova." },
  "Hockey hierba, base y senior.": { en: "Field hockey, youth and senior.", sr: "Hokej na travi, mlađi i seniori." },
  "Cinturones desde blanco a negro.": { en: "Belts from white to black.", sr: "Pojasevi od belog do crnog." },
  "Kata y kumite, todas las edades.": { en: "Kata and kumite, all ages.", sr: "Kata i kumite, svi uzrasti." },
  "Lucha grecorromana y libre.": { en: "Greco-Roman and freestyle wrestling.", sr: "Grčko-rimsko i slobodno rvanje." },
  "Senderismo, alpinismo y BTT.": { en: "Hiking, mountaineering and MTB.", sr: "Planinarenje, alpinizam i MTB." },
  "Aprendizaje, perfeccionamiento y competición.": { en: "Learning, improvement and competition.", sr: "Učenje, usavršavanje i takmičenja." },
  "Coro polifónico del club.": { en: "Club's polyphonic choir.", sr: "Klubski polifonijski hor." },
  "Liga interna y escuela técnica.": { en: "Internal league and technical school.", sr: "Interna liga i tehnička škola." },
  "Pelota mano y paleta.": { en: "Hand and paddle pelota.", sr: "Pelota rukom i palicom." },
  "Aguas tranquilas y travesías.": { en: "Flatwater and touring.", sr: "Mirne vode i ture." },
  "Equipos masculino, femenino y base.": { en: "Men's, women's and youth teams.", sr: "Muške, ženske i mlađe ekipe." },
  "Escuela y entrenamiento de competición.": { en: "School and competitive training.", sr: "Škola i takmičarski trening." },
  "Pistas de tierra batida y dura.": { en: "Clay and hard courts.", sr: "Šljakasti i tvrdi tereni." },
  "Recurvo y compuesto, sala y aire libre.": { en: "Recurve and compound, indoor and outdoor.", sr: "Recurve i compound, u sali i na otvorenom." },
  "Optimist, Láser y travesías.": { en: "Optimist, Laser and touring.", sr: "Optimist, Laser i ture." },
  "Equipos absolutos y categorías base.": { en: "Senior and youth teams.", sr: "Seniorske i mlađe ekipe." },

  // ─── RGCC · Venues ────────────────────────────────────────────────────
  "Sede principal con más de 80.000 m² dedicados al deporte y la actividad social.": { en: "Main venue with over 80,000 m² for sport and social activity.", sr: "Glavni objekat sa preko 80.000 m² za sport i društvene aktivnosti." },
  "Local histórico del club en La Arena.": { en: "Club's historic venue at La Arena.", sr: "Istorijski klupski objekat u La Areni." },
  "Sede urbana de Begoña en el corazón de Gijón.": { en: "Urban Begoña venue in the heart of Gijón.", sr: "Urbani Begoña objekat u srcu Hihona." },
  "Sede del antiguo Centro Asturiano de la Habana.": { en: "Former Asturian Centre of Havana venue.", sr: "Nekadašnji objekat Asturijskog Centra iz Havane." },
  "Gijón centro": { en: "Gijón centre", sr: "Centar Hihona" },
  "La Arena · zona playa": { en: "La Arena · beach area", sr: "La Arena · plažni deo" },
  "Begoña · centro Gijón": { en: "Begoña · Gijón centre", sr: "Begoña · centar Hihona" },
  "Mareo · zona exterior": { en: "Mareo · outdoor area", sr: "Mareo · spoljni deo" },
  Piscina: { en: "Pool", sr: "Bazen" },
  Tenis: { en: "Tennis", sr: "Tenis" },
  Pádel: { en: "Padel", sr: "Padel" },
  Cafetería: { en: "Cafeteria", sr: "Kafeterija" },
  Vestuarios: { en: "Locker rooms", sr: "Svlačionice" },
  ...
  Otro: { en: "Other", sr: "Ostalo" },
  Vacaciones: { en: "Vacation", sr: "Odmor" },
  Enfermedad: { en: "Illness", sr: "Bolest" },
  "Asuntos propios": { en: "Personal leave", sr: "Lični dan" },
  "Lumbalgia, parte médico enviado.": { en: "Low-back pain, medical note sent.", sr: "Lumbalgija, lekarski nalaz poslat." },
