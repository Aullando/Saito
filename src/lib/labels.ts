...
export const roleLabel = (role: Role, lang: Lang): string => {
  switch (role) {
    case "admin": return STR.recipient_role_admin[lang];
    case "manager": return STR.recipient_role_manager[lang];
    case "technical": return STR.recipient_role_technical[lang];
    case "medical": return STR.recipient_role_medical[lang];
