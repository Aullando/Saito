...
export const Route = createFileRoute("/_public/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Plataforma todo-en-uno para clubes deportivos: socios, calendario, pagos, comunicación e IA por rol. IA privada por diseño." },
      { property: "og:title", content: "SAITO — Plataforma para clubes deportivos" },
      { property: "og:description", content: "Socios, calendario, pagos y comunicación en un solo lugar. IA integrada." },
    ],
