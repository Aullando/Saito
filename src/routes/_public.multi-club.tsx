...
export const Route = createFileRoute("/_public/multi-club")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Para clubes históricos y entidades polideportivas con varias sedes y secciones.",
      },
      { property: "og:title", content: "Multi-club — SAITO" },
      {
        property: "og:description",
        content: "Gobierno central, autonomía por sección y datos consolidados.",
      },
    ],
