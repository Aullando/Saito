...
export const Route = createFileRoute("/_public/precios")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Planes que crecen con tu club. Sin permanencia y con migración asistida.",
      },
      { property: "og:title", content: "Precios — SAITO" },
      {
        property: "og:description",
        content: "Planes Club, Pro y Multi-club. Habla con ventas para una propuesta a medida.",
      },
    ],
